<div class="home-portfolio home-margin carousel_outerrim home-padding">
    ...
    <div class="clearfix">
        <h3 class="hometitle"><?php echo esc_html($porttitle); ?></h3>
    </div>
    ...
    <div class="home-margin fredcarousel">
        <div id="carouselcontainer-portfolio" class="rowtight fadein-carousel">
            <div id="portfolio-carousel" class="clearfix caroufedselclass initcaroufedsel clearfix"
                 data-carousel-container="#carouselcontainer-portfolio" data-carousel-transition="700"
                 data-carousel-scroll="1" data-carousel-auto="true" data-carousel-speed="9000"
                 data-carousel-id="portfolio" data-carousel-md="<?php echo esc_attr($md); ?>"
                 data-carousel-sm="<?php echo esc_attr($sm); ?>" data-carousel-xs="<?php echo esc_attr($xs); ?>"
                 data-carousel-ss="<?php echo esc_attr($ss); ?>">
                <?php
                $temp = $wp_query;
                $wp_query = null;
                        ...
                        <div class="<?php echo $itemsize; ?> kad_portfolio_item">
                            <div class="grid_item portfolio_item postclass">
                                <?php if (has_post_thumbnail($post->ID)) {
                                    ...
                                    <div class="imghoverclass">
                                        <a href="<?php the_permalink() ?>" title="<?php the_title(); ?>"
                                           class="kad_portfolio_link">
                                            <img src="<?php echo esc_url($image); ?>" alt="<?php the_title(); ?>"
                                                 width="<?php echo esc_attr($slidewidth); ?>"
                                                 height="<?php echo esc_attr($slideheight); ?>" class="lightboxhover"
                                                 style="display: block;">
                                        </a>
                                    </div>
                                    <?php $image = null;
                                ...
                                <a href="<?php the_permalink() ?>" class="portfoliolink">
                                    <div class="piteminfo">
                                        <h5><?php the_title(); ?></h5>
                                        <?php if ($portfolio_item_types == 1) {
                                            $terms = get_the_terms($post->ID, 'portfolio-type');
                                            if ($terms) { ?>
                                                <p class="cportfoliotag"><?php $output = array();
                        ...
                        <div class="grid_item portfolio_item postclass">
                            ...
                            <a href="<?php the_permalink() ?>" class="portfoliolink">
                                <div class="piteminfo">
                                    <h5><?php the_title(); ?></h5>
                                    <?php if ($portfolio_item_types == 1) { ?>
                                            <p class="cportfoliotag"><?php echo $cat->name; ?></p>
                                    <?php } ?>
                                </div>
                            </a>
                        </div>
