 ...
 * Import and Export
 */
class import_export_settings_admin_theme extends Option_admin_theme
{
    protected function render_control()
    {
        wp_enqueue_script('aupload_js', get_template_directory_uri() . '/core/admin/js/ajaxupload.js');
        return '
        <div class="gt3_UploadButton_admin_settings_cont">
            <input type="button" class="gt3_UploadButton_admin_settings gt3_admin_button" id="gt3_UploadButton_admin_settings" value="Import Admin Settings">
            <div class="impexp_response"></div>
        </div>
        <div class="gt3_export_admin_settings_cont">
            <a class="gt3_admin_button" href="?gt3_export_admin_settings">Export Admin Settings</a>
            <div class="exp_response"></div>
        </div>
        ';
    }
}
