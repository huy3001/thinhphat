...
if (function_exists('register_sidebar')) {
    ...
    $register_sidebar_attr = array(
        'description' => esc_html__('Add the widgets appearance for Custom Sidebar. Drag the widget from the available list on the left, configure widgets options and click Save button. Select the sidebar on the posts or pages in just few clicks.', 'elitemasters'),
    ...
    $register_footer_sidebar_attr = array(
		'description' => esc_html__('Display and style the footer area with multiple widgets. Simply drag the widgets from the left, make the adjustments to the widget according the needs. Preview the front end.', 'elitemasters'),
		'before_widget' => '<div class="col-sm-3"><div class="sidepanel %2$s">',
