...
if (function_exists('vc_map')) {
    vc_map(array(
        'base' => 'gt3_partners',
        'name' => esc_html__('Partners', 'elitemasters'),
        "description" => esc_html__("Display partners", "elitemasters"),
        'category' => esc_html__('GT3 Modules', 'elitemasters'),
        'icon' => site_url(str_replace(ABSPATH, '', __DIR__ . '/')) . 'icon.png',
        'params' => array(
            array(
                'type' => 'loop',
                'heading' => esc_html__('Partners Items', 'elitemasters'),
                'param_name' => 'build_query',
                'settings' => array(
                    'size' => array('hidden' => false, 'value' => 4 * 3),
                    'order_by' => array('value' => 'date'),
                    'post_type' => array('value' => 'partners', 'hidden' => false),
            ...
            array(
                ...
                'admin_label' => true,
                'value' => array(
                    esc_html__("Type 1", "elitemasters") => 'type_1',
                    esc_html__("Type 2", "elitemasters") => 'type_2',
                ),
            ),
        )
    ));

    class WPBakeryShortCode_Gt3_Partners extends WPBakeryShortCode
    {
    }
}