...
if (function_exists('vc_map')) {
    vc_map(array(
        ...
        'name' => esc_html__('Testimonials', 'elitemasters'),
        "description" => esc_html__("Display testimonials", "elitemasters"),
        'category' => esc_html__('GT3 Modules', 'elitemasters'),
        'icon' => site_url(str_replace(ABSPATH, '', __DIR__ . '/')) . 'icon.png',
        'params' => array(
            array(
                'type' => 'loop',
                'heading' => esc_html__('Testimonials Items', 'elitemasters'),
                'param_name' => 'build_query',
                'settings' => array(
                    'size' => array('hidden' => false, 'value' => 4 * 3),
                    'order_by' => array('value' => 'date'),
                    'post_type' => array('value' => 'testimonials', 'hidden' => false),
